...
namespace Enrollment.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public ActionResult AddEditAvailableSubjectsPartial([ModelBinder(typeof(DevExpressEditorsBinder))]
            int? availableSubjectId)
        {
        ...
        {
            var model = unitOfWork.AvailableSubjectsRepo.Get(
                includeProperties: "AvailableCourses,Subjects,UserDetails");
            return PartialView("_AvailableSubjectsGridView", model);
        }

        [HttpPost, ValidateInput(false)]
        [OnUserAuthorization("Add Available Subject")]
        public ActionResult AvailableSubjectsGridViewAddNew([ModelBinder(typeof(DevExpressEditorsBinder))]
            Models.AvailableSubjects item)
        {
        ...
        public ActionResult AvailableSubjectsGridViewUpdate([ModelBinder(typeof(DevExpressEditorsBinder))]
            Models.AvailableSubjects item)
        {
        ...
        public ActionResult AvailableSubjectsGridViewDelete([ModelBinder(typeof(DevExpressEditorsBinder))]
            System.Int32 Id)
        {
        ...
        public ActionResult AddEditSubjectPartial([ModelBinder(typeof(DevExpressEditorsBinder))]
            int? subjectId)
        {
        ...
        public ActionResult SubjectsGridViewPartialAddNew([ModelBinder(typeof(DevExpressEditorsBinder))]
            Models.Subjects item)
        {
        ...
        public ActionResult SubjectsGridViewPartialUpdate([ModelBinder(typeof(DevExpressEditorsBinder))]
            Models.Subjects item)
        {
        ...
        public ActionResult SubjectsGridViewPartialDelete([ModelBinder(typeof(DevExpressEditorsBinder))]
            System.Int32 Id)
        {
        ...
        public ActionResult CboSubjectsPartial([ModelBinder(typeof(DevExpressEditorsBinder))]
